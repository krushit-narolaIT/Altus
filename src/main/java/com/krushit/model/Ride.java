...
public class Ride {
    ...
    public static class RideBuilder {
        ...
        public RideBuilder setPickLocationId(int pickLocationId) {
            this.pickLocationId = pickLocationId;
            return this;
        }

        public RideBuilder setDropOffLocationId(int dropOffLocationId) {
            this.dropOffLocationId = dropOffLocationId;
            return this;
        }

        public RideBuilder setCustomerId(int customerId) {
            this.customerId = customerId;
            return this;
        }

        public RideBuilder setDriverId(int driverId) {
