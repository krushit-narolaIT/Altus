...
@WebServlet(value = "/getAllVehicleServices")
public class GetAllVehicleServicesController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            List<VehicleService> locations = vehicleRideService.getAllVehicleServices();
