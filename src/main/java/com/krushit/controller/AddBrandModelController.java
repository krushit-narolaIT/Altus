...
public class AddBrandModelController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            BrandModel newBrandModel = objectMapper.readValue(request.getReader(), BrandModel.class);

//            if (newBrandModel.getServiceId() ||
//                    newBrandModel.getBrandName() == null || newBrandModel.getBrandName().trim().isEmpty() ||
//                    newBrandModel.getModel() == null || newBrandModel.getModel().trim().isEmpty() ||
//                    newBrandModel.getMinYear() == null) {
//
...
//            }
            ...
            vehicleRideService.addBrandModel(newBrandModel);
            createResponse(response, "Brand model added successfully!", null, HttpServletResponse.SC_OK);
