...
public class DriverDAO {
    ...
    public void registerDriver(User driver) throws ApplicationException {
        try (Connection connection = DBConnection.getConnection()) {
            if (isDriverExist(driver.getEmailId()))
                throw new ApplicationException(Message.DRIVER_ALREADY_EXIST);
    ...
    public List<Driver> fetchPendingVerificationDrivers() {
        List<Driver> drivers = new ArrayList<>();
        String query = "SELECT * FROM drivers WHERE document_verified = false";
