...
public class GetAllBrandsController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            AuthUtils.validateAdminAndDriverRole(user);
            List<String> allBrands = vehicleRideService.getAllBrands();
            if (!allBrands.isEmpty()) {
                createResponse(response, Message.Vehicle.SUCCESSFULLY_RETRIEVED_BRANDS, allBrands, HttpServletResponse.SC_OK);
            } else {
